...
local Settings = {
    AutoCapture = { 
        ...
        Delay = 5.0,
        TeleportDelay = 0.3,
        ClickSpeed = 0.05, -- Velocidade dos cliques (menos = mais rápido)
        TotalClicks = 50    -- Número de cliques para encher a barra
    },
    ESP = {
        Enabled = false,
...
local function ThrowLasso(pet)
    ...
    -- 4. Fallback: clicar no pet para lançar o laço
